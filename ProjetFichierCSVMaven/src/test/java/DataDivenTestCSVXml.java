...
public class DataDivenTestCSVXml {
    ...
    public Iterator<Object[]> preparerDataProvider() {
        ...
        try {
            ...
            for (Element row : rows) {
                ...
                String demande = row.getChildText("Demande");
                String date = row.getChildText("Date");
                String nbHeures = row.getChildText("NbHeures");
                String commentaire = row.getChildText("Commentaire");
                String activite = row.getChildText("Activite");
