...
public class DataDrivenTestJsonTestNG {
            ...
            if (rootNode != null && rootNode.has("root")) {
                ...
                if (rowsNode != null && rowsNode.isArray()) {
                    for (JsonNode rowNode : rowsNode) {
                        ...
                        String demande = getTextNodeValue(rowNode, "Demande", "");
                        String date = getTextNodeValue(rowNode, "Date", "");
                        String nbHeures = getTextNodeValue(rowNode, "NbHeures", "");
                        String commentaire = getTextNodeValue(rowNode, "Commentaire", "");
                        String activite = getTextNodeValue(rowNode, "Activite", "");
